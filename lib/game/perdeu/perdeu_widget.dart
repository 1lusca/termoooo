...
import 'perdeu_model.dart';
export 'perdeu_model.dart';

class PerdeuWidget extends StatefulWidget {
  const PerdeuWidget({Key? key}) : super(key: key);

  @override
  _PerdeuWidgetState createState() => _PerdeuWidgetState();
}

class _PerdeuWidgetState extends State<PerdeuWidget> {
  late PerdeuModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PerdeuModel());
  }
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Lottie.asset(
                  'assets/lottie_animations/114059-alien-in-rain-emoji-animation.json',
                  width: 200.0,
                  height: 200.0,
                  fit: BoxFit.contain,
                  animate: true,
              ...
              Padding(
                ...
                child: Text(
                  'Palavra ${FFAppState().palavraAtual}',
                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                        fontFamily: 'Mitr',
                        color: Colors.white,
                        fontSize: 20.0,
